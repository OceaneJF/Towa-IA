...
public class ActionsPossibles {
     ...
     */
    final static int MAX_NB_ACTIONS = 1028;
    ...
    /**
     * Retourne l'action sans les vitalités. Par exemple, sur "PbD,4,5",
     * cela renvoit "PbD".
     *
     * @param actionVita l'action avec des vitalités
     * @return l'action sans les vitalités
     */
    static String enleverVitalites(String actionVita) {
        int posVirgule = actionVita.indexOf(",");
        return posVirgule == -1 ? actionVita : actionVita.substring(0, posVirgule);
    }
